...
export const hero = {
  ...
  // Optional: public share link (Google Drive, OneDrive etc.). If provided, buttons will open this link in a new tab.
...
export const contact = {
  ...
  cta: {
    ...
    resumePath: '/resume.pdf',
    // Public share link for resume (Google Drive/OneDrive). If set, Contact CTA will open it in a new tab.
    resumeDriveLink: 'https://drive.google.com/file/d/1vNl4eprM9F6LfbUGiYfRwIh464Zc5pSr/view?usp=sharing',
  },
  // Optional: set to your form endpoint (e.g., Formspree, Netlify Functions, Supabase edge function).
  // If empty, the site will fallback to opening the user's email client (mailto).
  formEndpoint: '',
  footerText: '© 2025 Shahid Shahadat Khan. Built with React, TypeScript, and Tailwind CSS.',
};
